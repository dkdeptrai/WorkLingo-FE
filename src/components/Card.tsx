  ...
  return (
    <div className="p-3">
      <div className="h-full bg-[#064580] border-opacity-60 rounded-lg overflow-hidden p-3 flex flex-col w-96 h-44">
        <h6 className="text-white text-sm font-semibold mr-auto ml-1 mb-2">
          {lessonName}
        </h6>
        <div className="flex flex-row mb-12">
          <p className="text-black text-sm bg-white text-black rounded-full p-1 font-semibold">
            {flashcardCount} thuật ngữ{" "}
          </p>
          <span className="ml-auto flex flex-row">
            <StarRatings
              ...
              starSpacing="1px"
            />
            <p className="text-white text-sm font-normal mt-1 ml-1">
